...
import {uploadMedia, downloadMedia, deleteMedia, getThumbnail, streamMedia, listConversationMedia} from '../controllers/mediaController.js';
...
router.get('/conversation/:conversationId', protect, listConversationMedia);
